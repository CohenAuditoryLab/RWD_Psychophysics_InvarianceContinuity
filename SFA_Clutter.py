...
import soundfile as sf #update doesn't work on Anaconda3 but does work on Anaconda2
...
for a_round in range(0,10):
    ...
    for iteration in range(0,7):
        ...
        vocal_files = ['Clutter_Stimuli/Base_Stimulus_Parabola_SS_1.wav', 'Clutter_Stimuli/Base_Stimulus_Parabola_SS_2.wav', 'Clutter_Stimuli/Base_Stimulus_Parabola_SS_3.wav'] #set names of files to be played/trained and tested on
        ...
        num_samples = num_vocals * 10 #note current results on screen were with 15 examples, trying one last go at three vocalization then going to cut loses for tonight and stop #choose how many times you see each stimulus
