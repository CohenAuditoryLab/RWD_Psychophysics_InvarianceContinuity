...
for a_stimulus in range(0,5):
    ...
    for a_round in range(0,10):
        ...
        vocal_files_train = ['Stimulus_Set_1/AM_Stimulus_2_1.5.wav', 'Stimulus_Set_1/AM_Stimulus_4_2.5.wav', 'Stimulus_Set_1/AM_Stimulus_5_3.wav',\
        ...
        vocal_files_test = ['Stimulus_Set_1/AM_Stimulus_1_1.wav', list_of_names[a_stimulus] ]
